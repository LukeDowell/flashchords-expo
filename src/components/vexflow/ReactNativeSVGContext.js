...
import { VexFlow, SVGContext } from 'vexflow';
import Svg, { Path, Rect, G } from 'react-native-svg';


/**
 * Bless u https://github.com/RechieKho/react-native-vexflow/tree/master
 */
export default class ReactNativeSVGContext extends SVGContext {
    ...
    fillText(text, x, y) {
        // Removed https://github.com/0xfe/vexflow/commit/164f4f28115bfcb37b7792e3846b973033aaf7c7#diff-fed09fa70c13eb421c30c5b79189debbcbe191becd47d6dd64e2170793125a05
        // VexFlow.Merge(attributes, this.attributes);
